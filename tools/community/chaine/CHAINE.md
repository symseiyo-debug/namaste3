...
| état, **daté** | 🔴 **absente à 21:47 UTC** (recherche non bornée sur `/root` et tout le chantier : 0 fichier) · 🟢 **présente et lancée à 21:56 UTC** — elle a été écrite entre mes deux mesures. *Une affirmation d'absence porte l'heure de sa mesure, sinon elle vieillit en silence et devient fausse sans que personne ne s'en aperçoive.* |
